...
No fancy stuff, no nonsense, just an Importer and a few extensions to the existing C# Hashtable and ArrayList classes. 
And it doesn't start throwing exceptions the second your JSON isn't 100% according to standards either.
